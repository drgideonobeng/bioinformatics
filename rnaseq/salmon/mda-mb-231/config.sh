...
export PROJECT_NAME="Homo_sapiens_PRJNA1427211"
...
export TRANSCRIPTOME_URL="https://ftp.ensembl.org/pub/release-115/fasta/homo_sapiens/cdna/Homo_sapiens.GRCh38.cdna.all.fa.gz"
export TRANSCRIPTOME_FA="${REF_DIR}/GRCh38_transcriptome.fa.gz"

export GENOME_URL="http://https://ftp.ensembl.org/pub/release-115/fasta/homo_sapiens/dna/Homo_sapiens.GRCh38.dna.primary_assembly.fa.gz"
export GENOME_FA="${REF_DIR}/GRCh38_genome.fa.gz"
...
while IFS=',' read -r samp treat || [ -n "$samp" ]; do
    ...
    # 2. Skip the heahttps://ftp.ensembl.org/pub/release-115/fasta/homo_sapiens/cdna/Homo_sapiens.GRCh38.cdna.all.fa.gzder row and any completely blank lines
...
export CONTROL_TREATMENT="CTRV2_control"
