...
export PROJECT_NAME="MSC"
export GEO_ACCESSION="GSM8650786"
...
export MIN_GENES=700
export MAX_GENES=10000
export MAX_MT_PERCENT=10

export PCA_DIMS=15
export CLUSTER_RES=0.4
export UMAP_TITLE="${PROJECT_NAME} cells"
