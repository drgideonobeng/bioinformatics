...
cluster_identities <- c(
  "0" = "Somitic Mesoderm",
  "1" = "Mesoderm Progenitors",
  "2" = "Posterior Mesoderm",
  "3" = "Primitive Erythroid",       # "Primitive" is accurate for early yolk sac blood
  "4" = "Endothelial Progenitors",
  "5" = "Splanchnic Mesoderm",       # Adjusted for developmental time
  "6" = "Early Cardiomyocytes",
  "7" = "Lateral Plate Mesoderm",
  "8" = "Migratory Neural Crest",      # Adjusted from Cardiac Fibroblasts
  "9" = "Neuroectoderm"                # More precise than general Epithelium
)
