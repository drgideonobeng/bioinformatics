...
# scripts/02_qc_and_integration.R
...
for (i in 1:nrow(meta)) {
  ...
  message(glue("Processing {sid} ({genotype})..."))
...
pdf(path(plot_dir, "02_harmony_umap_split.pdf"), width = 12, height = 6)
...
message("\nStep 02:QC and Harmony Integration complete. Visuals saved to plots directory, object saved to: ", save_path)
