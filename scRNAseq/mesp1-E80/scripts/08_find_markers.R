...
# Increase number of threads/workers to 8
plan(multicore, workers = 8)

# Increase the global access limit to 8GB
options(future.globals.maxSize = 8 * 1024^3)

message("==========Parallel processing activated==========")
...
top_genes_path <- path(tables_dir, "05_top_cluster_markers_cheatsheet.csv")
