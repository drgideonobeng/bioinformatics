...
# 3. Define the biological identities based on our E9.5 marker genes
...
cluster_identities <- c(
  ...
  "2" = "Pharyngeal Endoderm",
  "3" = "Second Heart Field",
  "4" = "Pharyngeal Mesoderm",
  "5" = "Pharyngeal Arch Endothelium",
  "6" = "Dorsal Neural Tube",
  "7" = "Cardiomyocytes",
  "8" = "Cranial Neural Crest",
  "9" = "Hindbrain",
  "10" = "Cranial Ganglia / Neuroblasts"
)
