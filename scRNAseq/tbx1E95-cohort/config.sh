...
export PROJECT_NAME="Tbx1_Cohort"
...
export INTEGRATION_METHOD="harmony"
export OBJ_DIR="${ROOT_DIR}/results_${INTEGRATION_METHOD}/objects"
export PLOT_DIR="${ROOT_DIR}/results_${INTEGRATION_METHOD}/plots"
export TABLE_DIR="${ROOT_DIR}/results_${INTEGRATION_METHOD}/tables"
