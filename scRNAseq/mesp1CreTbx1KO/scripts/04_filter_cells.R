...
load_path <- path(obj_dir, "02_seurat_unfiltered.rds")
...
# 4. Save the cleanly filtered (but un-normalized & scaled) object
save_path <- path(obj_dir, "04_seurat_filtered.rds")
