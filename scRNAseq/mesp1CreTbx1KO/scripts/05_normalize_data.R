...
message("Showing Top 20 most highly variable genes")
top20 <- head(VariableFeatures(seurat_obj), 20)
print(top20)

# 4. Scale the data (applies Z-score transformation to every gene independently)
message("Scaling the data to apply Z-score transformation to every gene")
