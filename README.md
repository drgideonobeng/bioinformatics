...
Welcome to my bioinformatics repository. This space serves as a centralized hub for the computational pipelines and workflows I have developed to explore complex biological questions.

As a cell biologist by training, my approach to data is driven by a deep curiosity about how molecular signatures dictate cellular fate. I am passionate about bridging the gap between high-throughput sequencing data and meaningful biological narratives. This portfolio demonstrates my ability to build modular, automated, and reproducible pipelines using R, Python, and Bash to extract insights from multiomic and transcriptomic datasets.
...
Functional Genomics: Multiomic integration and CRISPR-Cas9 screen analysis
...
I have automated the quantification and statistical evaluation of high-throughput CRISPR screens. These scripts are designed to identify essential genetic dependencies across different cellular contexts, providing a functional layer to transcriptomic findings.

Biological Intuition and Data Rigor
Bioinformatics is more than just running software; it is about ensuring that the computational output aligns with biological reality. I prioritize:

Biological Validation: I sanity-check every trajectory and cluster against known developmental markers and metabolic shifts to ensure the results are grounded in biology.

Scalable Automation: I utilize configuration scripts and wrapper functions to ensure pipelines can handle expanding datasets with minimal manual intervention.
